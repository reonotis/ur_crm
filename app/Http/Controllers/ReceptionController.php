...
class ReceptionController extends UserAppController
{
     ...
     * @return array
     */
    private function makeBasicReport(Collection $visitHistories): array
    {
        $basicReport = [];
        $basicReport['todayCount'] = count($visitHistories);
        $basicReport['opeMembers'] = $visitHistories->groupBy('user_id');
        return $basicReport;
    }
