...
class CreateHistorySendingEmailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_sending_emails', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('history_sending_emails');
    }
}
